...
Bios::Bios(function<void(uint8_t* buff, int size)> read_callback, Vga& vga, Kbc& kbc){
    ...
    this->bios_functions[BIOS_FUNCTION::FLOPPY_FUNCTION]          = make_unique<FloppyFunction>(read_callback);
